...
system_prompt = ("""
    ...
    - Первым делом идет вдохновляющее вступление с вопросом **"Начнём?"** в конце и ожидание подтверждения пользователя, только затем сообщения с основными вопросами.
